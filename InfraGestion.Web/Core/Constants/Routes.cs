...
public static class ApiRoutes
{
    ...
    public static class Users
    {
        ...
        public static string CreateUser(int administratorId) => $"{Base}/administrator/{administratorId}";
    ...
    // ==========================================
    // DEVICES CONTROLLER (replaces InventoryController)
    // ==========================================
    public static class Devices
    {
        private const string Base = "api/devices";
        
        /// <summary>GET /api/devices/user/{userId}</summary>
        public static string GetAllDevices(int userId) => $"{Base}/user/{userId}";
        
        /// <summary>GET /api/devices/user/{userId}/sections/{sectionId}</summary>
        public static string GetDevicesBySection(int userId, int sectionId) 
            => $"{Base}/user/{userId}/sections/{sectionId}";
        
        /// <summary>GET /api/devices/user/{userId}/my-section-devices</summary>
        public static string GetMySectionDevices(int userId) => $"{Base}/user/{userId}/my-section-devices";
        ...
        /// <summary>PUT /api/devices</summary>
        public const string UpdateDevice = Base;
    ...
    public static class Inspections
    {
        ...
        public static string GetAdminRequests(int adminId) 
            => $"{Base}/admin/{adminId}/requests";
    ...
    public static class Organization
    {
        ...
        public static string GetDepartmentsBySection(int sectionId) => $"{Base}/sections/{sectionId}/departments";
    }
