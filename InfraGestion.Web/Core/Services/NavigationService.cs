...
public class NavigationService
{
    ...
    private static class Icons
    {
        ...
        public const string MyTransfers = "M213.66,181.66l-32,32a8,8,0,0,1-11.32-11.32L188.69,184H48a8,8,0,0,1,0-16H188.69l-18.35-18.34a8,8,0,0,1,11.32-11.32l32,32A8,8,0,0,1,213.66,181.66Zm-139.32-64a8,8,0,0,0,11.32-11.32L67.31,88H208a8,8,0,0,0,0-16H67.31L85.66,53.66A8,8,0,0,0,74.34,42.34l-32,32a8,8,0,0,0,0,11.32Z";
        
        // ICONO: Poner aquí el path de tu icono de mantenimiento/herramientas
    ...
    /// <summary>
    /// Obtiene todos los items de navegación disponibles para un rol específico
    /// </summary>
    ...
    /// <summary>
    /// Definición de todos los items de navegación del sistema
    /// </summary>
    private List<NavItem> GetAllNavItems()
    {
        ...
        [
            ...
            new NavItem
            {
                ...
                IconPath = Icons.Maintenance, // Icono de mantenimiento
                AllowedRoles = [Roles.Technician],
                Order = 30
            },
            new NavItem
            ...
            {
                Title = "Bajas Técnicas",
                Route = "specialist/decommissioning",
                IconPath = Icons.Decommissioning,
                AllowedRoles = [Roles.Specialist],
                Order = 30
            },
